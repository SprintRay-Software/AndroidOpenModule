...
package com.sprintray.net.crash;
...
public final class CustomActivityOnCrash {
    ...
    private static CashConfig config = new CashConfig();
                        ...
                        public void uncaughtException(Thread thread, final Throwable throwable) {
                            if (config.isEnabled()) {
                                ...
                                if (hasCrashedInTheLastSeconds(application)) {
                                    ...
                                    } else if (config.getBackgroundMode() == CashConfig.BACKGROUND_MODE_SHOW_CUSTOM || !isInBackground) {
                                    ...
                                    } else if (config.getBackgroundMode() == CashConfig.BACKGROUND_MODE_CRASH) {
                                        if (oldHandler != null) {
                                            oldHandler.uncaughtException(thread, throwable);
                                            return;
                                        }
     ...
     */
    @NonNull
    public static CashConfig getConfigFromIntent(@NonNull Intent intent) {
        return (CashConfig) intent.getSerializableExtra(CustomActivityOnCrash.EXTRA_CONFIG);
    }
     ...
     */
    public static void restartApplicationWithIntent(@NonNull Activity activity, @NonNull Intent intent, @NonNull CashConfig config) {
    ...
    public static void restartApplication(@NonNull Activity activity, @NonNull CashConfig config) {
     ...
     * @param config   The config object as obtained by calling getConfigFromIntent.
     */
    public static void closeApplication(@NonNull Activity activity, @NonNull CashConfig config) {
        if (config.getEventListener() != null) {
    ...
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    @NonNull
    public static CashConfig getConfig() {
        return config;
    }
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static void setConfig(@NonNull CashConfig config) {
